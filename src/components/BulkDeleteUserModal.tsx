...
export const BulkDeleteUserModal: React.FC<BulkDeleteUserModalProps> = ({ isOpen, onClose, onConfirm, count, theme }) => {
          ...
          >
            <div className="p-8 text-center">
              ...
              <p className={cn(
                ...
                Are you sure you want to delete <span className="font-bold text-red-500">{count} users</span>? This action is permanent and will delete all their links and data.
              </p>
